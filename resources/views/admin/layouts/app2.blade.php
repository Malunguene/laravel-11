	  ...
	  <div class="app-menu">
		<ul class="header-megamenu nav">
			<li class="btn-group nav-item">
				<a href="#" class="waves-effect waves-light nav-link push-btn btn-primary" data-toggle="push-menu" role="button">
      ...
      <div class="navbar-custom-menu r-side">
        <ul class="nav navbar-nav">
			<li class="btn-group nav-item d-lg-inline-flex d-none">
				<a href="#" data-provide="fullscreen" class="waves-effect waves-light nav-link full-screen btn-primary" title="Full Screen">
					<i data-feather="maximize"></i>
			    </a>
			</li>
		  <!-- Notifications -->
		  <li class="dropdown notifications-menu">
			<a href="#" class="waves-effect waves-light dropdown-toggle btn-primary" data-bs-toggle="dropdown" title="Notifications">
          ...
          <li>
              <a href="#" data-toggle="control-sidebar" title="Setting" class="waves-effect waves-light btn-primary">
		...
		<div class="user-panel">
			<div class="d-flex align-items-center">
				<div class="image m-15">
				  <img src="../images/user2-160x160.jpg" class="rounded max-w-50" alt="User Image">
				</div>
				<div class="info text-start">
				  <h5 class="mb-0 text-white">Fox Template</h5>
		  ...
		  <div class="multinav-scroll" style="height: 100%;">
			  ...
			  <div class="sidebar-widgets">
				<div class="copyright text-start m-25">
					<p class="text-white-50"><strong class="d-block text-white-50">Fox Admin Dashboard</strong> © 2022 All Rights Reserved
</p>
				</div>
			  </div>
		  </div>
  ...
  <div class="content-wrapper">
	  <div class="container-full">
		...
		<div class="content-header">
			<div class="d-flex align-items-center">
				<div class="me-auto">
					<h4 class="page-title">@yield('seccao')</h4>
					<div class="d-inline-block align-items-center">
						<nav>
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
								<li class="breadcrumb-item" aria-current="page">@yield('seccao')</li>
   ...
   <footer class="main-footer">
    <div class="pull-right d-none d-sm-inline-block">
        <ul class="nav nav-primary nav-dotted nav-dot-separated justify-content-center justify-content-md-end">
		  ...
		  <li class="nav-item">
			<a class="nav-link" href="https://themeforest.net/item/fox-multipurpose-bootstrap-admin-4-dashboard-template-ui-kit/20677102" target="_blank">Purchase Now</a>
